...
if(isset($_REQUEST['submit']) and $_REQUEST['submit'] == 'adduser')
{
    ...
    ?>
                ...
                <form name="add_user" id="add_user" action="user.php" method="POST" enctype="multipart/form-data" class="admin_form">    
        ...
        elseif(isset($_REQUEST['submit']) and $_REQUEST['submit'] == 'updatepick')
        {
				...
				<section id="left_menu" <?php if (isset($_GET['last_message'])) echo 'style="height:calc(100% - 159px) !important"'; ?>>
					<ul id="Level-1" class="Level1">
                        ...
                        <form action="user.php" method="POST" enctype="multipart/form-data" class="admin_form">
                        <INPUT type="hidden" name="state" value="<?php echo ($_REQUEST['state']); ?>" />
                        <table border="0" cellspacing="5" cellpadding="5">
                        <tr>
                        <td><b><?php echo msg('userpage_user');?></b></td>
